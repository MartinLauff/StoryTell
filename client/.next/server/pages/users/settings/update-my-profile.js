...
const UpdateMyProfile = ({
  ...
  const {
    0: photo,
    1: setProfilePhoto
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(data.photo);
  const {
    0: username,
    1: setUsername
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(data.username);
  const {
    0: hobby,
    1: setHobby
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(data.hobby);
  const {
    0: email,
    1: setEmail
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(data.email);
  ...
  const doRequest = (url = data.photo) => {
    axios__WEBPACK_IMPORTED_MODULE_1___default()({
    ...
    }).then(() => next_router__WEBPACK_IMPORTED_MODULE_3___default().push('/users/my-profile')).catch(({
      response: {
        data
      }
    }) => setErrors( /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("div", {
      ...
      children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx("h4", {
        ...
        children: data.message.split(',').map(message => /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx("li", {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("div", {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("div", {
          ...
          children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx("img", {
            ...
            src: photo,
            alt: "profile picture"
          }), photo !== data.photo && /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx("div", {
            onClick: resetImg,
            ...
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("svg", {
              ...
              strokeLinecap: "round",
              strokeLinejoin: "round",
              children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx("line", {
                x1: "18",
                y1: "6",
                x2: "6",
                y2: "18"
              }), /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx("line", {
                x1: "6",
                y1: "6",
                x2: "18",
                y2: "18"
...
const getServerSideProps = async ctx => {
  ...
  const {
    data
  } = await client.get('/api/users/brief-user');
  return {
    props: {
      data
    }
...
var __webpack_exports__ = __webpack_require__.X(0, [400,664,853], () => (__webpack_exec__(4279)));
