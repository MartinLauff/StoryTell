...
const LikeSet = ({ postID , likes , greyColor , userId  })=>{
    ...
    const doRequest = async (path)=>{
        const http = axios_rate_limit__WEBPACK_IMPORTED_MODULE_2___default()(axios__WEBPACK_IMPORTED_MODULE_3___default().create(), {
            maxRequests: 1,
...
const CopyOption = ()=>{
    return(/*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        ...
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx(Icons_CopyLinkIcon, {
            }),
