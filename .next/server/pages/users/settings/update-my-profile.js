...
const UpdateMyProfile = ({ data  })=>{
    ...
    const { 0: photo , 1: setProfilePhoto  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(data.photo);
    const { 0: username , 1: setUsername  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(data.username);
    const { 0: hobby , 1: setHobby  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(data.hobby);
    ...
    const doRequest = (url = data.photo)=>{
        axios__WEBPACK_IMPORTED_MODULE_2___default()({
            ...
            withCredentials: true
        }).then(()=>next_router__WEBPACK_IMPORTED_MODULE_4___default().push("/users/my-profile")).catch(({ response: { data  }  })=>setErrors(/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                ...
                                children: [
                                    ...
                                    photo !== data.photo && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                        onClick: resetImg,
...
var __webpack_exports__ = __webpack_require__.X(0, [676,664,853], () => (__webpack_exec__(7404)));
